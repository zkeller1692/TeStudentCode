...
const reviews = [
  {
    ...
    title: 'What a book!',
    review:
      "<img src='x' onerror='location.href=\"http://www.techelevator.com\"'><b>It certainly is a book.</b> I mean, I can see that. Pages kept together with glue (I hope that's glue) and there's writing on it, in some language.",
    rating: 3
  },
  {
...
function setPageTitle() {
  ...
  let titleSpan = pageTitle.querySelector('.name');
...
function addTitle(parent, title) {
  ...
  h3.innerText = title;
  parent.insertAdjacentElement('beforeend', h3);
...
function addReview(parent, review) {
  ...
  //reviewPara.innerText = review;
  reviewPara.innerHTML = review;
  parent.appendChild(reviewPara);
}
