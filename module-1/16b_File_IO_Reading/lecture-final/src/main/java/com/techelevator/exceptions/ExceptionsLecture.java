...
//		String nullStr = null;
//		nullStr.length(); <--- Unhandled exception in main goes to the default handler
...
//		}
		...
		try {
			...
			e.printStackTrace(System.out); // will print the Exception stacktrace to the terminal
		} finally {
		...
		System.out.println("About to go into a try/finally with no catch");

		try {
			System.out.println("First line");
			throw new IllegalArgumentException("Yeet");
			//System.out.println("Second line. Wont' run");
		} finally {
	 ...
	 * @return
	 * @throws OverdraftException when funds are insufficient
	 */
