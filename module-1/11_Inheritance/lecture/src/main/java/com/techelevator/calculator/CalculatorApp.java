...
//        System.out.println();
        ...
        int firstValue = this.getIntFromUser("Please enter first value: ", userInputScanner);
        int secondValue = this.getIntFromUser("Please enter second value: ", userInputScanner);
